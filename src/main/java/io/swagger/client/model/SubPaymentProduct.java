...
public class SubPaymentProduct {
  ...
  public boolean equals(Object o) {
    ...
    return (this.number == null ? subPaymentProduct.number == null : this.number.equals(subPaymentProduct.number)) &&
        (this.name == null ? subPaymentProduct.name == null : this.name.equals(subPaymentProduct.name));
  }
