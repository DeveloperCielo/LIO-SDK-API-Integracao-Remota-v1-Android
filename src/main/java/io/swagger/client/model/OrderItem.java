...
public class OrderItem {
  ...
  public boolean equals(Object o) {
    ...
    return (this.sku == null ? orderItem.sku == null : this.sku.equals(orderItem.sku)) &&
        (this.skuType == null ? orderItem.skuType == null : this.skuType.equals(orderItem.skuType)) &&
        (this.name == null ? orderItem.name == null : this.name.equals(orderItem.name)) &&
        (this.description == null ? orderItem.description == null : this.description.equals(orderItem.description)) &&
        (this.unitPrice == null ? orderItem.unitPrice == null : this.unitPrice.equals(orderItem.unitPrice)) &&
        (this.quantity == null ? orderItem.quantity == null : this.quantity.equals(orderItem.quantity)) &&
        (this.unitOfMeasure == null ? orderItem.unitOfMeasure == null : this.unitOfMeasure.equals(orderItem.unitOfMeasure)) &&
        (this.details == null ? orderItem.details == null : this.details.equals(orderItem.details)) &&
        (this.createdAt == null ? orderItem.createdAt == null : this.createdAt.equals(orderItem.createdAt)) &&
        (this.updatedAt == null ? orderItem.updatedAt == null : this.updatedAt.equals(orderItem.updatedAt));
  }
