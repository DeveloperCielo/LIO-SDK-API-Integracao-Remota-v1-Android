...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    INSTANCE.authentications.put("access-token", new ApiKeyAuth("header", "access-token"));
    INSTANCE.authentications.put("client-id", new ApiKeyAuth("header", "client-id"));
    INSTANCE.authentications.put("merchant-id", new ApiKeyAuth("header", "merchant-id"));
